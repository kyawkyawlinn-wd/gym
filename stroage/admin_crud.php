...
function add_admin($mysqli, $trainer_name, $exp, $age, $password, $email){
    $hashed = password_hash($password,PASSWORD_BCRYPT);
    $sql = "INSERT INTO `trainers`(`trainer_name`,`exp`,`age`,`password`,`email`) VALUE ('$trainer_name', $exp, $age, '$hashed', '$email')";
